...
public class RunnerTPCamera : MonoBehaviour
{
    private static RunnerTPCamera _instance;
    public static RunnerTPCamera instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = GameObject.FindObjectOfType<RunnerTPCamera>();
    ...
    void CameraMovement()
    {
        ...
        float targetDistance = lockCamera ? lockonDistance : defaultDistance;
        ...
        Vector3 targetPos = lockCamera ? twoPointsCenter : currentTarget.position;
