...
public static class GamePadName
{
    ...
    public const string GameStick_Left_X = "L_GamePad1_X";
    public const string GameStick_Left_Y = "L_GamePad1_Y";
    public const string GameStick_Right_X = "R_GamePad1_X";
    public const string GameStick_Right_Y = "R_GamePad1_Y";
    public const string GamePad_RB = "RB_1";
    public const string GamePad_A = "A_1";
